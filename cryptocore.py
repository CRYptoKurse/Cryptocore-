...
class CryptoCore:
    ...
    def process_file(self, algorithm: str, mode: str, operation: str,
                     key_hex: str, input_file: str, output_file: str, iv_hex: str = None):
        ...
        # Добавление IV к выходным данным при шифровании
...
def main():
    ...
    # Генерация имени выходного файла если не указан (CLI-5 из Спринта 1)
    if not args.output:
